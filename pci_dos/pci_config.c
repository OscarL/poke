...
#define	in8(p)		in_port_8(p)
#define	in16(p)		in_port_16(p)
#define	in32(p)		in_port_32(p)
#define	out8(v, p)	out_port_8(p, v)
#define	out16(v, p)	out_port_16(p, v)
#define	out32(v, p)	out_port_32(p, v)
